<template>
  <div class="w-full h-auto" :class="{
      ...
      'fill-with-margin pt-[160px]': props.screen && !props.section && !props.container && props.margin,
      'pt-[160px]': props.screen && !props.section && !props.container,
      'snap': props.section || props.screen,
      'min-h-[100vh]': props.screen && !props.section && !props.container && !props.margin,
      'pl-[15px] pr-[15px]': props.padding && !props.container
  }">
    <div :class="{
      'fill-with-margin': props.screen && props.margin,
      'pt-[160px]': props.screen,
      'min-h-[100vh]': props.screen && !props.margin,
