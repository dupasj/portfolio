...
class Animation{
   ...
   */
  setRepeatEventManager(repeat_event){
   ...
   */
  setPauseEventManager(pause_event){
   ...
   */
  setResumeEventManager(resume_event){
   ...
   */
  setStopEventManager(stop_event){
   ...
   */
  setStartEventManager(start_event){
   ...
   */
  setBeginEventManager(begin_event){
   ...
   */
  setAbordEventManager(abord_event){
   ...
   * @return {(coef) => void} Return the function binder of the current {@link Animation|Animation} instance
   */
  getBinder(){
    return this._binder;
  }
   ...
   * @return {(coef) => number} Return easing function of the current {@link Animation|Animation} instance
   */
  getEasing(){
    return this._easing;
  }
   ...
   * @internal
   */
  setPausePosition(pause_position,update_parent = true){
   ...
   * @internal
   */
  setStartedAtTimeline(timeline,update_parent = true){
   ...
   * @return {Animation} Return the current {@link Animation|Animation} instance
   */
  setTimeline(timeline,update_parent = true){
    if (this.isRunning()){
   ...
   * @return {Animation} Return the current {@link Animation|Animation} instance
   */
  setPosition(coef,update_parent = true){
